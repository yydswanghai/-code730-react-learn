...
import { setLoading, setStudentsAndTotal, fetchStudents } from '../action/student/searchResult'
...
function* generatorFn() {
    ...
    try {
        ...
        yield put(setStudentsAndTotal(res.data, res.total));
    } catch (err) {
...
export default function* (){
    yield takeEvery(fetchStudents.toString(), generatorFn)
}